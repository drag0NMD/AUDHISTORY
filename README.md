...
Установка
Скачай репозиторий:
Открой в Chrome chrome://extensions/
Включи Developer mode в правом верхнем углу
Жми Load unpacked и выбери папку audhistory/
Иконка появится в тулбаре
...
Click Load unpacked and select the audhistory/ folder
